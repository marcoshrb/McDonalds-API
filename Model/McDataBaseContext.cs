...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see http://go.microsoft.com/fwlink/?LinkId=723263.
        => optionsBuilder.UseSqlServer("Data Source=CT-C-001YG\\SQLEXPRESS;Initial Catalog=McDataBase;Integrated Security=True;TrustServerCertificate=true");

    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        modelBuilder.Entity<ClientOrder>(entity =>
        {
            entity.HasKey(e => e.Id).HasName("PK__ClientOr__3214EC2769EA9DD9");
        ...
        {
            entity.HasKey(e => e.Id).HasName("PK__ClientOr__3214EC273164D8F2");
        ...
        {
            entity.HasKey(e => e.Id).HasName("PK__MenuItem__3214EC2760ABEE8F");
        ...
        {
            entity.HasKey(e => e.Id).HasName("PK__Product__3214EC27D8EE99D3");
        ...
        {
            entity.HasKey(e => e.Id).HasName("PK__Store__3214EC27AFE35509");
